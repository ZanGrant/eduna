...
export default function QuizMuseumRajaAliHaji() {
  ...
  const questions = [
    ...
    // dummy questions 2–10
    {
      ...
      options: ["Tuhfat al-Nafis", "Syair Perahu", "Gurindam 12", "Hikayat Abdullah"],
      answer: 2,
    },
    {
      img: null,
  ...
  const leaderboard = [
    {
      ...
      name: "Irfan",
      score: 950,
      avatar: "/assets/dummy/1.png", 
      badge: "/assets/icons/badge-gold.png",
    },
    {
      id: 2,
      name: "Marvel",
      score: 940,
      avatar: "/assets/dummy/2.png",
      badge: "/assets/icons/badge-silver.png",
    },
    {
      id: 3,
      name: "Imam",
      score: 930,
      avatar: "/assets/dummy/3.png",
      badge: "/assets/icons/badge-bronze.png",
    },
  ];
  /* ================================================================ */
  ...
  /* SOUND */
  const correctSound =
    typeof window !== "undefined" ? new Audio("/assets/sounds/correct.mp3") : null;
  const wrongSound =
    typeof window !== "undefined" ? new Audio("/assets/sounds/wrong.mp3") : null;
